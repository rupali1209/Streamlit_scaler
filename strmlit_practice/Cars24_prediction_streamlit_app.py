...
cars_df = pd.read_excel("/Users/rupaligupta/Downloads/ML Ops/model_files_class_2/cars24-car-price.xlsx")
...
def model_pred(fuel_type, transmission_type, engine, seats):
    ## loading the model
    with open("/Users/rupaligupta/Downloads/ML Ops/model_files_class_2/car_pred", 'rb') as file:
...
if (st.button("Predict Price")):
    ...
    price = np.round(model_pred(fuel_type, transmission_type, engine, seats),2)
